...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17369 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17369 = (function (val,box,meta17370){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17369.cljs$lang$type = true;
cljs.core.async.impl.channels.t17369.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17369";
cljs.core.async.impl.channels.t17369.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write.call(null,writer__4126__auto__,"cljs.core.async.impl.channels/t17369");
});
cljs.core.async.impl.channels.t17369.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17369.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17371){var self__ = this;
var _17371__$1 = this;return self__.meta17370;
});
cljs.core.async.impl.channels.t17369.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17371,meta17370__$1){var self__ = this;
var _17371__$1 = this;return (new cljs.core.async.impl.channels.t17369(self__.val,self__.box,meta17370__$1));
});
cljs.core.async.impl.channels.__GT_t17369 = (function __GT_t17369(val__$1,box__$1,meta17370){return (new cljs.core.async.impl.channels.t17369(val__$1,box__$1,meta17370));
});
}
return (new cljs.core.async.impl.channels.t17369(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_17372 = self__.takes.pop();if((taker_17372 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17372))
{var take_cb_17373 = cljs.core.async.impl.protocols.commit.call(null,taker_17372);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17373,taker_17372,this$__$1){
return (function (){return take_cb_17373.call(null,null);
});})(take_cb_17373,taker_17372,this$__$1))
);
} else
{}
{

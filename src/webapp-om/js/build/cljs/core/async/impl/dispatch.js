...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17363 = (0);while(true){
var m_17364 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17364 == null))
{} else
{m_17364.call(null);
if((count_17363 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17365 = (count_17363 + (1));
count_17363 = G__17365;
continue;
}
} else
{}

...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_17270 = (0);while(true){
if((i_17270 < arr.length))
{(arr[i_17270] = null);
{
var G__17271 = (i_17270 + (1));
i_17270 = G__17271;
continue;
}
} else
...
{var i_17277 = (self__.level + (1));while(true){
if((i_17277 <= (new_level + (1))))
{(update[i_17277] = self__.header);
{
var G__17278 = (i_17277 + (1));
i_17277 = G__17278;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17279 = (0);while(true){
if((i_17279 <= self__.level))
{var links_17280 = (update[i_17279]).forward;if(((links_17280[i_17279]) === x__$1))
{(links_17280[i_17279] = (x__$1.forward[i_17279]));
{
var G__17281 = (i_17279 + (1));
i_17279 = G__17281;
continue;
}
} else
{{
var G__17282 = (i_17279 + (1));
i_17279 = G__17282;
continue;
}
}
